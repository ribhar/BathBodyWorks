      ...
      <div>
        ...
        >
          ...
          <p style={{ marginTop: "20px", color: "rgb(104, 99, 99)" }}>
            How do you fill your home with incredible, always-on fragrance? Plug
            in a Bath & Body Works Wallflowers air freshener, of course! And
            with so many different fragrances, you’ll never get bored with the
            options. Keep reading for our advice on picking out the best plugs
            and scents for your home.
          </p>
          <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
            ...
            collect your go-to essentials throughout the year and switch up the
            scents anytime you want. Keep an eye out for our new Enhanced
            Fragrance refills — your favorites are better than ever.
          </p>
          <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
            Bonus: thanks to our blend of scented essential oils, our
            Wallflowers can even help eliminate unwanted odor. (We all love our
            pets, but sometimes we have to say bye to that lingering smell...)
          </p>
          <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
            <span style={{ fontWeight: "bold" }}>Second step: </span>find your
            Wallflowers plug — our version of a diffuser. Pick one that matches
            your décor, fits the season or completely stands out from the rest
            of your home. Not only are these fragrance plugs gorgeous to look
            at, some even have a built-in night light (perfect for midnight
            snack runs).
          </p>
          <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
            And if you’re wondering if our plugs will have enough power to fill
            a huge room (or if they’ll be too strong for your smaller
            rooms…a.k.a. bathrooms), we’ve got a solution you’ll love:
            Wallflowers Scent Control™ Plugs. Just plug it in and choose from
            three intensity levels (low, medium and high) to fit whichever room
            it’s in. Learn more with our Essential Guide to Wallflowers Air
            Fresheners.
          </p>
          <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
            <span style={{ fontWeight: "bold" }}>Third (and final) step: </span>
            put the plug in an outlet and breathe! It’s that easy. Now every
            time you walk in the room, you’re greeted with always-on fragrance.
            Hello, happiness.
          </p>
        </div>
      </div>
