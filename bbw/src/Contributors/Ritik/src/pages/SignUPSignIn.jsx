...
const SignUPSignIn = () => {
  ...
  const notifyTwo = () => toast.warning("Invalid credentials",{
  ...
  const onSigninSubmit = (e) => {
    ...
    if(userData.email==signin.email && userData.password==signin.password){
      signin.email = "";
      signin.password = "";
      notify()
  ...
  const notifySignup = () => toast.success("Signup successfull",{
      ...
      <div className={styles.rimain}>
        <div>
          ...
          <form onSubmit={onSigninSubmit}>
            ...
            <input type="submit" className={styles.risubmit} value="SIGN IN" />
          </form>
        </div>
