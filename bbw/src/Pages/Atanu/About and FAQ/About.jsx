  ...
  return (
    <div>
      ...
      <p style={{ margin: "20px 100px 10px 100px", color: "rgb(102, 98, 98)" }}>
        We work hard to improve our communities and our planet in a way that
        will make us proud for years to come ... because we believe the world is
        a better place when everyone has access to the things that make them
        happy.
      </p>
      <p style={{ margin: "20px 100px 10px 100px", color: "rgb(102, 98, 98)" }}>
        Bath & Body Works is an international company that sells personal care
        and beauty products in more than 1,700 North American stores and has
        nearly 300 stores in countries around the globe operating under
        franchise, license and wholesale arrangements. The company's products
        are also available online at{" "}
        <Link to="/" style={{ color: "rgb(142, 183, 245)" }}>
