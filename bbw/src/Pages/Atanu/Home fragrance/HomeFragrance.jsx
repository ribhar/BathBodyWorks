...
import styles from "../Home fragrance/HomeFragrance.module.css";
          ...
          <div>
            ...
            >
              ...
              <p style={{ marginTop: "20px", color: "rgb(104, 99, 99)" }}>
                True story: Bath & Body Works candles turn your house into a
                home. All it takes is the perfect fragrance (or two) (or five!)
                and you’re instantly in a scented wonderland.
              </p>
              <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
                ...
                scents to choose from, our candles are the perfect way to add
                that extra touch of magic when you’re hosting guests. That
                feeling when someone says “OMG, it smells so good in here”? It’s
                our fave compliment.
              </p>
              <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
              ...
              <p style={{ marginTop: "30px", color: "rgb(104, 99, 99)" }}>
                Pro tip: candles also make incredible gifts, so stock up on a
                few of your loves to keep in your gift closet. You never know
                when those occasions might pop up. Bonus points if you pick out
                a candle holder or accessory to throw in the package (or just
                for yourself).
              </p>
            </div>
          </div>
